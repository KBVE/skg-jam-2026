// Vendored stroke icons (Lucide-style, currentColor, 24×24) from the kbve
// rareicon set. Inlined here so they ship same-origin — external icon fonts /
// CDNs would be blocked under the game's cross-origin isolation (COEP).
// Icons render at 1em, so callers size them with `font-size`.
...
const ICONS: Record<string, string> = {
  ...
  robot:
    '<path d="M6 6a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2Z"/><path d="M12 2v2"/><path d="M9 12v9"/><path d="M15 12v9"/><path d="M5 16l4-2"/><path d="M15 14l4 2"/><path d="M9 18h6"/><path d="M10 8v.01"/><path d="M14 8v.01"/>',
  hourglass:
...
export function Icon({ name, className }: { name: string; className?: string }) {
  return (
    <svg
      ...
      dangerouslySetInnerHTML={{ __html: ICONS[name] ?? ICONS.help }}
    />
  );
}
